...
const std::string &gStr_phenotype = EidosRegisteredString("phenotype", gID_phenotype);
const std::string &gStr_phenotype4 = EidosRegisteredString("phenotype4", gID_phenotype4);
const std::string &gStr_ODEPars = EidosRegisteredString("ODEPars", gID_ODEPars);
...
const std::string &gStr_getMolTraitsAtPosition = EidosRegisteredString("getMolTraitsAtPosition", gID_getMolTraitsAtPosition);
...
const std::string &gStr_setSelectionCoeff = EidosRegisteredString("setMolTraitFX", gID_setMolTraitFX);
...
const std::string &gStr_getQuantileODEPar = EidosRegisteredString("getQuantileODEPar", gID_getQuantileODEPar);
